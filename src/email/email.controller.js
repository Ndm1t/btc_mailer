...
var EmailController = function () {
    var _classDecorators = [(0, common_1.Controller)('email')];
    ...
    var EmailController = _classThis = /** @class */ (function () {
        function EmailController_1(emailService, subscribedCounter, unsubscribedCounter) {
            this.emailService = (__runInitializers(this, _instanceExtraInitializers), emailService);
            this.subscribedCounter = subscribedCounter;
            this.unsubscribedCounter = unsubscribedCounter;
        }
        EmailController_1.prototype.list = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.emailService.findAll()];
                });
            });
        };
        EmailController_1.prototype.subscribe = function (createEmailDto) {
            return __awaiter(this, void 0, void 0, function () {
                var existingEmail;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.emailService.findOne(createEmailDto.email)];
                        case 1:
                            ...
                            return [4 /*yield*/, this.emailService.create(createEmailDto)];
                        case 2: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        EmailController_1.prototype.unsubscribe = function (createEmailDto) {
            return __awaiter(this, void 0, void 0, function () {
                var existingEmail;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.emailService.delete(existingEmail)];
                        case 2: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    (function () {
        ...
        _subscribe_decorators = [(0, common_1.Post)()];
        _unsubscribe_decorators = [(0, common_1.Delete)()];
