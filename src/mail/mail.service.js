...
var MailService = function () {
    ...
    var MailService = _classThis = /** @class */ (function () {
        function MailService_1(mailerService, sentCounter, failedCounter) {
            this.mailerService = mailerService;
            this.sentCounter = sentCounter;
            this.failedCounter = failedCounter;
        }
        MailService_1.prototype.sendSubscribersCurrencyRate = function (emails, rate) {
            return __awaiter(this, void 0, void 0, function () {
                var sentEmails, emailPromises;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            sentEmails = [];
                            emailPromises = emails.map(function (email) { return __awaiter(_this, void 0, void 0, function () {
                                var e_1;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                        ...
                                        case 2:
                                            ...
                                            console.log("Couldn't send mail to ".concat(email));
                                            return [3 /*break*/, 3];
